    ...
    SilicaFlickable {
        ...
        Column {
            ...
            Label {
                ...
                textFormat: Text.RichText
                wrapMode: Text.WordWrap
                text: qsTr("<p><em>Welcome to Flappy Rocket, an exciting, fast-paced adventure where you control a cutting-edge space rocket. Copyright (c) © 2024-2025 dFlap ® 🐾</em></p>")
            }
        }
    }
}
